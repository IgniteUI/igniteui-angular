...
describe("Navigation Drawer", function() {
        ...
        it("should properly initialize with min template", async(() => {
            const template = '<ig-nav-drawer><div class="ig-drawer-content"></div><div class="ig-drawer-mini-content"></div></ig-nav-drawer>';
            TestBed.overrideComponent(TestComponentDI, {
            set: {
                template
            }});
            ...
            TestBed.compileComponents().then(() => {
                ...
                expect(fixture.debugElement.query((x) => x.nativeNode.nodeName === "ASIDE").nativeElement.classList).toContain("mini");
            }).catch ((reason) => {
                console.log(reason);
                return Promise.reject(reason);
            });
        ...
        it("should set pin, gestures options", async(() => {
            ...
            TestBed.compileComponents().then(() => {
                ...
                expect(fixture.debugElement.query((x) => x.nativeNode.nodeName === "ASIDE").nativeElement.classList).toContain("pinned");
        ...
        it("should update edge zone with mini width", async(() => {
            let template = '<ig-nav-drawer [miniWidth]="drawerMiniWidth" ><div class="ig-drawer-content"></div><div class="ig-drawer-mini-content"></div></ig-nav-drawer>',
        ...
        it("should update width from css or property", (done) => {
            let template = `<ig-nav-drawer [miniWidth]="drawerMiniWidth" [width]="drawerWidth">
