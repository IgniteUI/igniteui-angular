...
export const CalendarResourceStringsNL = {
    ...
    igx_calendar_previous_year: 'Vorig jaar',
    igx_calendar_next_year: 'Volgend jaar',
    igx_calendar_previous_years: 'Vorige {0} jaar',
    igx_calendar_next_years: 'Volgende {0} jaar',
    igx_calendar_select_date: 'Selecteer datum',
    ...
    igx_calendar_range_label_start: 'Begin',
    igx_calendar_range_label_end: 'Einde',
    igx_calendar_range_placeholder: 'Selecteer bereik',
