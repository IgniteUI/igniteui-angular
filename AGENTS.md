...
| Figma to App | [`skills/igniteui-angular-figma-to-app/SKILL.md`](skills/igniteui-angular-figma-to-app/SKILL.md) | Building Angular apps from Figma screens designed with the Indigo.Design UI Kits |
