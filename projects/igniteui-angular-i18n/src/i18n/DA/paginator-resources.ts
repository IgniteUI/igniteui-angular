...
const PaginatorResourceStringsDA_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsDA = PaginatorResourceStringsDA_ as ExpandRequire<IPaginatorResourceStrings>;
