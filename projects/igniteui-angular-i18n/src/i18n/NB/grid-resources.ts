...
import { GridResourceStringsNB as AGridResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const GridResourceStringsNB = prefixResource(IGX_PREFIX, AGridResourceStrings);
