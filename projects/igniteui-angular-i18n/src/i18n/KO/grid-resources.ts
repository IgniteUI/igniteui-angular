...
export const GridResourceStringsKO = {
    ...
    igx_grid_filter_null: '널',
    igx_grid_filter_notNull: '널이 아님',
    igx_grid_filter_before: '전에',
    igx_grid_filter_after: '후에',
    igx_grid_filter_at: '지정한 값과 같음',
    igx_grid_filter_not_at: '지정한 값과 다름',
    igx_grid_filter_at_before: '지정한 값 이전',
    igx_grid_filter_at_after: '지정한 값 이후',
    ...
    igx_grid_filter_in: '포함',
    igx_grid_filter_notIn: '포함 안 함',
    ...
    igx_grid_advanced_filter_from_label: '부터',
    ...
    igx_grid_advanced_filter_switch_group: '{0} 으로 전환',
    igx_grid_advanced_filter_add_condition: '조건 추가',
    igx_grid_advanced_filter_add_group: '그룹 추가',
    igx_grid_advanced_filter_add_condition_root: '조건',
    igx_grid_advanced_filter_add_group_root: '그룹',
    ...
    igx_grid_advanced_filter_query_value_placeholder: '하위 쿼리 결과',
    igx_grid_advanced_filter_select_entity: '엔터티 선택',
    igx_grid_advanced_filter_select_return_field_single: '반환 필드 선택',
    igx_grid_advanced_filter_dialog_title: '확인',
    igx_grid_advanced_filter_dialog_message: '엔터티를 변경하면 현재 설정이 손실됩니다. 계속하시겠습니까?',
    igx_grid_advanced_filter_dialog_checkbox_text: '이 대화 상자를 다시 표시하지 않기',
    igx_grid_advanced_filter_drop_ghost_text: '삽입하려면 여기에 드롭',
