...
import { DateRangePickerResourceStringsRO as ADateRangePickerResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const DateRangePickerResourceStringsRO = prefixResource(IGX_PREFIX, ADateRangePickerResourceStrings);
