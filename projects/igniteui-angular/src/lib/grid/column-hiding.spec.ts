...
import { IgxColumnHidingItemDirective } from '../grid-common/column-hiding/column-hiding-item.directive';
import { IColumnVisibilityChangedEventArgs } from '../grid-common/common/grid-interfaces';
...
import { ColumnDisplayOrder } from '../grid-common/column-hiding/column-chooser-base';
