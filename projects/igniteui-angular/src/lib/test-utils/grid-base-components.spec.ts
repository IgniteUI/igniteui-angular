...
export class BasicGridComponent {
    ...
    @ViewChild(IgxGridComponent, /* TODO: add static flag */ {})
...
export class ColumnHidingTestComponent extends GridWithSizeComponent implements OnInit, AfterViewInit {
    @ViewChild(IgxColumnHidingComponent, /* TODO: add static flag */ {}) public chooser: IgxColumnHidingComponent;
    width = '500px';
    height = '500px';
    showInline = true;
    disableFilter = false;
...
export class ColumnGroupsHidingTestComponent extends ColumnHidingTestComponent {
    @ViewChild(IgxGridComponent, /* TODO: add static flag */ {}) grid: IgxGridComponent;
...
export class ColumnPinningTestComponent extends GridWithSizeComponent implements AfterViewInit, OnInit {
    @ViewChild(IgxColumnPinningComponent, /* TODO: add static flag */ {}) public chooser: IgxColumnPinningComponent;
