...
@Component({
    template: `
        <igx-grid [autoGenerate]="autoGenerate" [data]="data">
            <igx-column *ngIf="initializeColumnInTemplate" field="Test"></igx-column>
        </igx-grid>
    `,
    standalone: true,
    imports: [IgxGridComponent, IgxColumnComponent, NgIf]
})
export class GridAutoGeneratedAndTemplateColsComponent extends GridAutoGenerateComponent {
