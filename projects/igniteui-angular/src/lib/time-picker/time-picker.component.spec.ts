    ...
    describe('Interaction tests', () => {
        ...
        describe('FormControl integration', () => {
            ...
            it('should update validity state when programmatically setting errors on reactive form controls', () => {
                ...
                expect((timePicker as any).inputDirective.valid).toBe(IgxInputState.INVALID);
                expect((timePicker as any)._inputGroup.element.nativeElement.classList.contains(CSS_CLASS_INPUT_GROUP_INVALID)).toBe(true);
                expect((timePicker as any)._inputGroup.element.nativeElement.classList.contains(CSS_CLASS_INPUT_GROUP_REQUIRED)).toBe(true);
                ...
                expect((timePicker as any).inputDirective.valid).toBe(IgxInputState.INVALID);
                expect((timePicker as any)._inputGroup.element.nativeElement).toHaveClass(CSS_CLASS_INPUT_GROUP_INVALID);
                expect((timePicker as any)._inputGroup.element.nativeElement.classList.contains(CSS_CLASS_INPUT_GROUP_REQUIRED)).toBe(false);
            });
        });
    });
});
