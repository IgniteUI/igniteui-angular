...
export class ExcelStrings {
	...
	public static WORKSHEET_RELS_XML = ExcelStrings.XML_STRING + `<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/table" Target="../tables/table1.xml"/></Relationships>`;
	...
	public static getTablesXML(dimension: string, tableColumns: string) {
		return ExcelStrings.XML_STRING + `
		<table xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" id="1" name="Table1" displayName="Table1" ref="`+ dimension +`" totalsRowShown="0">
