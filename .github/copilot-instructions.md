...
- [`skills/igniteui-angular-figma-to-app`](../skills/igniteui-angular-figma-to-app/SKILL.md) — Translate Figma app screens into Angular apps — Indigo.Design UI Kits (1:1 component mapping), third-party kits, and plain frames (semantic mapping), with design token bridging, asset extraction, and visual validation
