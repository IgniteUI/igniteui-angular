...
import { CalendarResourceStringsZHHANT as ACalendarResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const CalendarResourceStringsZHHANT = prefixResource(IGX_PREFIX, ACalendarResourceStrings);
