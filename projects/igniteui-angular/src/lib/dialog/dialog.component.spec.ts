...
class AlertComponent {
    @ViewChild('dialog', /* TODO: add static flag */ {}) public dialog: IgxDialogComponent;
...
class NestedDialogsComponent {
    @ViewChild('child', /* TODO: add static flag */ {}) public child: IgxDialogComponent;
    @ViewChild('main', /* TODO: add static flag */ {}) public main: IgxDialogComponent;
}
