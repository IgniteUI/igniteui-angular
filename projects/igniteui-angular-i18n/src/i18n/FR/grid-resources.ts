...
export const GridResourceStringsFR = {
    ...
    igx_grid_filter_in: 'Dans',
    igx_grid_filter_notIn: 'Pas dans',
    ...
    igx_grid_advanced_filter_from_label: 'De',
    ...
    igx_grid_advanced_filter_switch_group: 'Passer à {0}',
    igx_grid_advanced_filter_add_condition: 'Ajouter une condition',
    igx_grid_advanced_filter_add_group: 'Ajouter un groupe',
    igx_grid_advanced_filter_add_condition_root: 'Condition',
    igx_grid_advanced_filter_add_group_root: 'Groupe',
    ...
    igx_grid_advanced_filter_query_value_placeholder: 'Résultats de la sous-requête',
    igx_grid_advanced_filter_select_entity: 'Sélectionner une entité',
    igx_grid_advanced_filter_select_return_field_single: 'Sélectionner le champ de retour',
    igx_grid_advanced_filter_dialog_title: 'Confirmation',
    igx_grid_advanced_filter_dialog_message: 'En changeant l\'entité, vous perdrez vos paramètres actuels. Êtes-vous sûr de vouloir faire cela ?',
    igx_grid_advanced_filter_dialog_checkbox_text: 'Ne plus afficher cette boîte de dialogue',
    igx_grid_advanced_filter_drop_ghost_text: 'Déposez ici pour insérer',
