...
- `IgxGrid`, `IgxTreeGrid`, `IgxHierarchicalGrid`:
    ...
    - `IgxCarousel`:
        ...
        - `nextButtonTemplate` directive is added, which can be used to provide a custom next button. If this property is not provided, a default next button will be used instead.
        - `prevButtonTemplate` directive is added, which can be used to provide a custom previous button. If this property is not provided, a default previous button will be used instead.
