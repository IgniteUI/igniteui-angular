...
export const GridResourceStringsJA = {
    ...
    igx_grid_filter_in: '～に含まれる',
    igx_grid_filter_notIn: '～に含まれない',
    ...
    igx_grid_advanced_filter_from_label: '開始',
    ...
    igx_grid_advanced_filter_switch_group: '開始:',
    igx_grid_advanced_filter_add_condition: '条件の追加',
    igx_grid_advanced_filter_add_group: 'グループの追加',
    igx_grid_advanced_filter_add_condition_root: '条件',
    igx_grid_advanced_filter_add_group_root: 'グループ',
    ...
    igx_grid_advanced_filter_query_value_placeholder: 'サブクエリの結果',
    igx_grid_advanced_filter_select_entity: 'エンティティの選択',
    igx_grid_advanced_filter_select_return_field_single: '返却フィールドの選択',
    igx_grid_advanced_filter_dialog_title: '確認',
    igx_grid_advanced_filter_dialog_message: 'エンティティを変更すると、現在の設定は失われます。続行しますか？',
    igx_grid_advanced_filter_dialog_checkbox_text: '今後このダイアログを表示しない',
    igx_grid_advanced_filter_drop_ghost_text: '挿入するにはここにドロップします',
