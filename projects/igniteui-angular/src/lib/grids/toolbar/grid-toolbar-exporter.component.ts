import { Component, ContentChild, Input, Output, EventEmitter, Optional } from '@angular/core';
import { IgxExcelTextDirective, IgxCSVTextDirective, BaseToolbarDirective } from './common';
import {
    CsvFileTypes,
    IgxBaseExporter,
