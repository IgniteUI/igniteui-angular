...
const CalendarResourceStringsJA_: ExpandRequire<ICalendarResourceStrings> = {
 ...
 */
export const CalendarResourceStringsJA = CalendarResourceStringsJA_ as ExpandRequire<ICalendarResourceStrings>;
