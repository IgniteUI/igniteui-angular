...
export class ExcelStrings {
    ...
    public static getSheetXML(dimension: string, freezePane: string, cols: string, sheetData: string, hasTable: boolean, outlineLevel = 0, isHierarchicalGrid: boolean, exportHeaders: boolean): string {
        ...
        const dimensions = isHierarchicalGrid || exportHeaders ? '' : `<dimension ref="${dimension}"/>`;
