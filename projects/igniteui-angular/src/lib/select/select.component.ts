...
export class IgxSelectComponent extends IgxDropDownComponent implements IgxSelectBase, ControlValueAccessor,
    ...
    */
    ...
    protected onStatusChanged() {
        if (this.ngControl instanceof FormControlName && (this.ngControl.control.touched || this.ngControl.control.dirty) &&
            (this.ngControl.control.validator || this.ngControl.control.asyncValidator)) {
            this.valid = this.ngControl.valid ? IgxSelectState.VALID : IgxSelectState.INVALID;
        } else if (this.ngControl instanceof NgModel && (this.ngControl.control.touched || this.ngControl.control.dirty &&
            (this.ngControl.control.validator || this.ngControl.control.asyncValidator))) {
            this.valid = this.ngControl.valid ? IgxSelectState.VALID : IgxSelectState.INVALID;
        }
    }
