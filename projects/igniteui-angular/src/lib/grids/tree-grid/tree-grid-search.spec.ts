...
describe('IgxTreeGrid - search API #tGrid', () => {
    ...
    describe('Primary/Foreign key', () => {
        ...
        it('Should update search highlights when sorting', () => {
            ...
            // Apply asc sorting
            treeGrid.columnsCollection.filter(c => c.field === 'JobTitle')[0].sortable = true;
            fix.detectChanges();
        ...
        it('Should update search highlights when a column is pinned/unpinned', () => {
            ...
            // Pin column
            const column = treeGrid.columnsCollection.filter(c => c.field === 'Name')[0];
            column.pinned = true;
            fix.detectChanges();
    ...
    describe('Scrollable TreeGrid', () => {
        beforeEach(async () => {
            ...
            treeGrid.columnsCollection[3].hasSummary = false;
            fix.detectChanges();
        });
