...
class CarouselDynamicSlidesComponent {
    ...
    constructor() {
        this.slides.push({ text: 'Slide 1', active: false }, { text: 'Slide 2', active: false }, { text: 'Slide 3', active: true }, { text: 'Slide 4', active: false });
    }
    ...
    public addSlides() {
        this.slides.push({ text: 'Slide 1' }, { text: 'Slide 2' });
    }
}
