...
describe('Pivot pipes', () => {
    ...
    it('transforms flat data to pivot data 2 value dimensions', () => {
        ...
        expect(columnPipeResult).toEqual([{
            'field1':'All','records':[
            {'field1':'All-Clothing','level':1,'All-UnitsSold':1526,'All-Bulgaria-UnitsSold':774,
            ...
            {'field1':'All-Bikes','level':1,'All-UnitsSold':68,'All-Uruguay-UnitsSold':68,
            'All-Uruguay-UnitPrice':3.56,'All-UnitPrice':3.56},
            {'field1':'All-Accessories','level':1,'All-UnitsSold':293,'All-USA-UnitsSold':293,
            'All-USA-UnitPrice':85.58,'All-UnitPrice':85.58},
            {'field1':'All-Components','level':1,'All-UnitsSold':240,'All-USA-UnitsSold':240,
