...
describe(`Update to ${version}`, () => {
    ...
    it('should remove hsla and hsl functions', async () => {
        appTree.create(`/testSrc/appPrefix/component/test.component.scss`, `.custom-body {
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/test.component.scss')).toEqual(`.custom-body {
    ...
    it('should remove the $border-width property from the badge-theme', async () => {
        appTree.create(`/testSrc/appPrefix/component/test.component.scss`, `$custom-badge: badge-theme(
                $text-color: red,
                $border-width: 2px
            );`);
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/test.component.scss')).toEqual(`$custom-badge: badge-theme(
                $text-color: red
            );`);
    });
});
