...
@Directive({
    ...
    host: {
        ...
        '[class.igx-button--ready]': '_hasRendered()',
...
export class IgxButtonDirective extends IgxButtonBaseDirective {
     ...
     * ```
     */
    @Input({ alias: 'igxButton', transform: (value: IgxButtonType | '' | null | undefined) => value || IgxButtonType.Flat })
