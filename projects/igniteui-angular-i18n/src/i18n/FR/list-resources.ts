...
const ListResourceStringsFR_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsFR = ListResourceStringsFR_ as ExpandRequire<IListResourceStrings>;
