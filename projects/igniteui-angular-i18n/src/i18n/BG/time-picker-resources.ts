...
import { TimePickerResourceStringsBG as ATimePickerResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const TimePickerResourceStringsBG = prefixResource(IGX_PREFIX, ATimePickerResourceStrings);
