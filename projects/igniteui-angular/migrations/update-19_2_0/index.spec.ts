...
describe(`Update to ${version}`, () => {
    ...
    it('should remove the properties related to invalid state from the switch theme', async () => {
        ...
        appTree.create(testFilePath, `$invalid-switch-theme: switch-theme(
                $label-color: orange,
        ...
        expect(tree.readContent(testFilePath)).toEqual(`$invalid-switch-theme: switch-theme(
                $label-color: orange,
            );`);
    });
    ...
    it('should remove unused properties from the calendar theme', async () => {
        ...
        appTree.create(testFilePath, `$calendar-theme: calendar-theme(
        ...
        expect(tree.readContent(testFilePath)).toEqual(`$calendar-theme: calendar-theme(
                $content-background: black
            );`);
    });
});
