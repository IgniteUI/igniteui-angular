...
import { GridResourceStringsBG as AGridResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const GridResourceStringsBG = prefixResource(IGX_PREFIX, AGridResourceStrings);
