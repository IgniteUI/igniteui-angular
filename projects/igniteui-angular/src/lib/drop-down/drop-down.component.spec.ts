...
describe('IgxDropDown ', () => {
    ...
    //  TODO: fix this test - when run it breaks some of the following tests
    xit('should select item by SPACE/ENTER and click', () => {
    ...
    it('Should support header items', (done) => {
        const fixture = TestBed.createComponent(IgxDropDownTestDisabledAnyComponent);
        fixture.detectChanges();
        const button = fixture.debugElement.query(By.css('button')).nativeElement;
        const list = fixture.componentInstance.dropdownDisabledAny;
    ...
    it('Should be able to implement to any kind of anchor', () => {
        // To DO
    });
    ...
    it('Esc key closes the dropdown and does not change selection', (done) => {
        const fixture = TestBed.createComponent(IgxDropDownTestComponent);
        fixture.detectChanges();
        const button = fixture.debugElement.query(By.css('button')).nativeElement;
        const list = fixture.componentInstance.dropdown;
    ...
    it('Unit: should close drop down when call close()', (done) => {
        const fixture = TestBed.createComponent(IgxDropDownTestComponent);
        const componentInstance = fixture.componentInstance;
        const igxDropDown = componentInstance.dropdown;
        fixture.detectChanges();
