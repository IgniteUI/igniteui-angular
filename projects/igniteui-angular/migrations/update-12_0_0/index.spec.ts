...
describe(`Update to ${version}`, () => {
    ...
    it('should update avatar theme args', async () => {
        appTree.create(`/testSrc/appPrefix/component/test.component.scss`, `
...
`);
    ...
    it('should replace onValueChange and onValueChanged with valueChange and dragFinished in igx-slider', async () => {
        appTree.create(`/testSrc/appPrefix/component/slider.component.html`, `<igx-slider
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/slider.component.html')).toEqual(`<igx-slider
    ...
    it('should replace onProgressChanged with progressChanged in igx-linear-bar', async () => {
        appTree.create(`/testSrc/appPrefix/component/linear.component.html`, `<igx-linear-bar [value]="currentValue" (onProgressChanged)="progressChange($event)"></igx-linear-bar>`);

        const tree = await schematicRunner.runSchematic(migrationName, { shouldInvokeLS: false }, appTree);

        expect(tree.readContent('/testSrc/appPrefix/component/linear.component.html')).toEqual(`<igx-linear-bar [value]="currentValue" (progressChanged)="progressChange($event)"></igx-linear-bar>`);
    });

    it('should replace onProgressChanged with progressChanged in igx-circular-bar', async () => {
        appTree.create(`/testSrc/appPrefix/component/circular.component.html`, `<igx-circular-bar [value]="currentValue" (onProgressChanged)="progressChange($event)"></igx-circular-bar>`);

        const tree = await schematicRunner.runSchematic(migrationName, { shouldInvokeLS: false }, appTree);

        expect(tree.readContent('/testSrc/appPrefix/component/circular.component.html')).toEqual(`<igx-circular-bar [value]="currentValue" (progressChanged)="progressChange($event)"></igx-circular-bar>`);
    });
...
`;
    ...
    it('Should update row component types with RowType', async () => {
        appTree.create('/testSrc/appPrefix/component/rows.component.ts', `
...
export class HGridMultiRowDragComponent {
    ...
    it('Should update toast output subscriptions', async () => {
        appTree.create('/testSrc/appPrefix/component/toast.component.ts', `
