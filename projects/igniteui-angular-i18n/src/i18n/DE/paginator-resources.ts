...
const PaginatorResourceStringsDE_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsDE = PaginatorResourceStringsDE_ as ExpandRequire<IPaginatorResourceStrings>;
