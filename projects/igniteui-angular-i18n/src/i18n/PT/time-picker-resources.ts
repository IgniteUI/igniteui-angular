...
const TimePickerResourceStringsPT_: ExpandRequire<ITimePickerResourceStrings> = {
 ...
 */
export const TimePickerResourceStringsPT = TimePickerResourceStringsPT_ as ExpandRequire<ITimePickerResourceStrings>;
