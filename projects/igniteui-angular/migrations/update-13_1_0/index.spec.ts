...
`);
    ...
    it('should rename @import to @use', async () => {
        appTree.create(`/testSrc/appPrefix/component/test.component.scss`, `@import '~igniteui-angular/lib/core/styles/themes/index';`);

        const tree = await schematicRunner
            .runSchematic(migrationName, {}, appTree);

        expect(tree.readContent('/testSrc/appPrefix/component/test.component.scss').replace(/\n|\r\n/g, '')).toEqual(`/* Line added via automated migrations. */
...
`);
    ...
    it('should remove columns` movable prop and enable grid`s moving prop in multiple files', async () => {
        appTree.create(`/testSrc/appPrefix/component/test1.component.html`, `
<igx-grid>
    <igx-column [movable]="true"></igx-column>
    <igx-column></igx-column>
</igx-grid>
`);
        appTree.create(`/testSrc/appPrefix/component/test2.component.html`, `
<igx-grid>
    <igx-column [movable]="true"></igx-column>
</igx-grid>
`);
        ...
        const tree = await schematicRunner
            .runSchematic(migrationName, {}, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/test1.component.html')).toEqual(`
<igx-grid [moving]="true">
    <igx-column ></igx-column>
    <igx-column></igx-column>
</igx-grid>
`);
        expect(tree.readContent('/testSrc/appPrefix/component/test2.component.html')).toEqual(`
<igx-grid [moving]="true">
    <igx-column ></igx-column>
</igx-grid>
`);
