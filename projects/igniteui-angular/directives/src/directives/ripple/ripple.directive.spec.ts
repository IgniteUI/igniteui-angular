...
describe('IgxRipple', () => {
    ...
    it('Should not affect host element size when ripple is triggered without CSS styles', () => {
        ...
        const rippleElement = setStylesSpy.mock.lastCall[0] as HTMLElement;
    ...
    it('Should create ripple element with position absolute style', () => {
        ...
        const positionStyleCall = setStyleSpy.mock.calls.find(args => args[1] === 'position' && args[2] === 'absolute'
        );
    ...
    it('Should apply custom ripple color as background style', () => {
        ...
        const backgroundStyleCall = setStyleSpy.mock.calls.find(args => args[1] === 'background' && args[2] === 'red'
        );
    ...
    it('Should center ripple when igxRippleCentered is true', () => {
        ...
        const topStyleCall = setStyleSpy.mock.calls.find(args => args[1] === 'top' && args[2] === '0px'
        );
        const leftStyleCall = setStyleSpy.mock.calls.find(args => args[1] === 'left' && args[2] === '0px'
        );
    ...
    it('Should apply ripple to target element when igxRippleTarget is specified', () => {
        ...
        expect(appendChildSpy.mock.lastCall[0]).toBe(targetButton);
    });
    ...
    it('Should set all required ripple element styles including position absolute', () => {
        ...
        const styles = styleCalls.map(args => args[1]);
        ...
        const positionCall = styleCalls.find(args => args[1] === 'position');
