    ...
    public onKeydown(event: KeyboardEvent) {
        ...
        switch (event.key) {
            ...
            case KEYS.RIGHT_ARROW_IE:
                do {
                    ...
                    if (currentIndex === tabsArray.length) {
                        currentIndex = -1;
                        continue;
                    } else if ((tabsArray[currentIndex] as IgxTabItemOldComponent).disabled === false) {
            ...
            case KEYS.HOME:
                ...
                finalIndex = tabsArray.find(t => (t as IgxTabItemOldComponent).disabled === false).index;
                break;
            case KEYS.END:
                event.preventDefault();
                finalIndex = tabsArray.slice().reverse().find(t => (t as IgxTabItemOldComponent).disabled === false).index;
                break;
            case KEYS.ENTER:
                if (!this.autoGenerated) {
