...
describe('IgxHierarchicalGrid Integration #hGrid', () => {
    ...
    describe('Row Pinning', () => {
        ...
        it('should have the correct records shown for pages with pinned rows', () => {
            ...
            [0, 1, 0, 1, 2, 3, 4].forEach((x, index) => expect(parseInt(rows[index].cells.first.value)).toEqual(x));
            ...
            [0, 1, 36, 37, 38, 39].forEach((x, index) => expect(parseInt(rows[index].cells.first.value)).toEqual(x));
        });
    });
});
