...
describe('Basic IgxHierarchicalGrid #hGrid', () => {
    ...
    describe('Init IgxHierarchicalGrid #hGrid', () => {
        ...
        it('should allow extracting child grids using hgridAPI', () => {
            ...
            // verify row is expanded
            expect(row1.expanded).toBe(true);
            const childGrid = hierarchicalGrid.gridAPI.getChildGrid([{ rowID: fixture.componentInstance.data[0], key: fixture.componentInstance.data[0], rowIslandKey: 'childData' }]);
            ...
            const grandChildGrid = hierarchicalGrid.gridAPI.getChildGrid([
                { rowID: fixture.componentInstance.data[0], key: fixture.componentInstance.data[0], rowIslandKey: 'childData' },
                { rowID: fixture.componentInstance.data[0].childData[0], key: fixture.componentInstance.data[0].childData[0], rowIslandKey: 'childData' }
            ]);
