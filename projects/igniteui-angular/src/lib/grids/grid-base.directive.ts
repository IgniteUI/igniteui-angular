...
export abstract class IgxGridBaseDirective extends DisplayDensityBase implements GridType,
    ...
    /**
     * Emitted when columns are auto-generated.
     *
     * @remarks
     * Returns the columns that were auto-generated.
     * @example
     * ```html
     * <igx-grid #grid [data]="localData" (columnsAutogenerated)="columnsAutogenerated($event)" [autoGenerate]="true"></igx-grid>
     * ```
     */
    @Output()
    public columnsAutogenerated = new EventEmitter<IgxColumnComponent[]>();
    ...
    */
    ...
    protected autogenerateColumns() {
        ...
        this.columnsAutogenerated.emit(this._autoGeneratedCols);
    }
