...
import { CarouselResourceStringsDA as ACarouselResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const CarouselResourceStringsDA = prefixResource(IGX_PREFIX, ACarouselResourceStrings);
