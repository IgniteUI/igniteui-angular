...
| `outlet` | **Deprecated.** Still honored by the overlay service for now, but will be removed in a future version. Prefer configuring a custom outlet via `overlaySettings.outlet`. | IgxOverlayOutletDirective \| ElementRef |
