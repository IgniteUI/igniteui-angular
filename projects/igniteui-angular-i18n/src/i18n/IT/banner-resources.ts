...
import { BannerResourceStringsIT as ABannerResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const BannerResourceStringsIT = prefixResource(IGX_PREFIX, ABannerResourceStrings);
