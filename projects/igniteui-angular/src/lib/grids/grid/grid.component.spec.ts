...
import { BasicGridComponent, GridAutoGeneratedAndTemplateColsComponent } from '../../test-utils/grid-base-components.spec';
...
describe('IgxGrid Component Tests #grid', () => {
    ...
    describe('IgxGrid - input properties', () => {
        ...
        it('should not render columns defined in the template when autoGenerate is true - issue #14260', () => {
            const fix = TestBed.createComponent(GridAutoGeneratedAndTemplateColsComponent);
            fix.detectChanges();

            let columns = fix.componentInstance.grid.columns;
            const properties = Object.keys(fix.componentInstance.data[0]);
            expect(columns.length).toEqual(properties.length);
