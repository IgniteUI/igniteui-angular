...
export class IgxGridCellStylesPipe implements PipeTransform {
    ...
    public transform(styles: { [prop: string]: any }, _: any, data: any, field: string,
        index: number, __: number): { [prop: string]: any } {
        const css = {};
        if (!styles) {
            return css;
        }
...
export class IgxGridRowPinningPipe implements PipeTransform {
    ...
    public transform(collection: any[], id: string, isPinned = false) {
...
export class IgxColumnActionEnabledPipe implements PipeTransform {
    ...
    public transform(
        ...
        actionFilter: (value: IgxColumnComponent, index: number, array: IgxColumnComponent[]) => boolean): IgxColumnComponent[] {
        if (!collection) {
            return collection;
        }
...
export class IgxFilterActionColumnsPipe implements PipeTransform {
    ...
    public transform(collection: IgxColumnComponent[], filterCriteria: string): IgxColumnComponent[] {
        if (!collection) {
            return collection;
        }
        let copy = collection.slice(0);
...
export class IgxSortActionColumnsPipe implements PipeTransform {
    ...
    public transform(collection: IgxColumnComponent[], displayOrder: ColumnDisplayOrder): IgxColumnComponent[] {
...
export class IgxGridAddRowPipe implements PipeTransform {
    ...
    public transform(collection: any, isPinned = false) {
        const grid = this.gridAPI.grid;
