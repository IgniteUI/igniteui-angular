...
describe("Avatar", function() {
    ...
    it("Initializes avatar with initials", () => {
        const fixture = TestBed.createComponent(InitAvatar);
    ...
    it("Initializes image avatar with src element", () => {
        const fixture = TestBed.createComponent(InitImageAvatar);
        fixture.detectChanges();
        const avatar = fixture.componentInstance.avatar;
    ...
    it("Should set ARIA attributes.", () => {
        const fixture = TestBed.createComponent(InitAvatarWithAria);
        fixture.detectChanges();
        const avatar = fixture.componentInstance.avatar;
