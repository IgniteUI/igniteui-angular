...
const CalendarResourceStringsTR_: ExpandRequire<ICalendarResourceStrings> = {
 ...
 */
export const CalendarResourceStringsTR = CalendarResourceStringsTR_ as ExpandRequire<ICalendarResourceStrings>;
