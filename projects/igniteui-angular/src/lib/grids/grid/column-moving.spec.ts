...
import { async, TestBed, fakeAsync, tick, flush, flushMicrotasks } from '@angular/core/testing';
...
fdescribe('IgxGrid - Column Moving', () => {
    ...
    xit('Should not break filtering, sorting and resizing when column moving is enabled.', fakeAsync(() => {
        const fixture = TestBed.createComponent(MovableColumnsComponent);
        fixture.detectChanges();
        const grid = fixture.componentInstance.grid;
    ...
    xit('Should close filter dialog, if opened, when column moving starts.', fakeAsync(() => {
        const fixture = TestBed.createComponent(MovableColumnsComponent);
        fixture.detectChanges();
        const grid = fixture.componentInstance.grid;
    ...
    xit('Should preserve filtering after columns are reordered.', fakeAsync(() => {
        const fixture = TestBed.createComponent(MovableColumnsComponent);
        fixture.detectChanges();
        const grid = fixture.componentInstance.grid;
    ...
    it('Should be able to reorder columns when a column is grouped.', fakeAsync(() => {
        const fixture = TestBed.createComponent(MovableColumnsComponent);
        fixture.detectChanges();
        const grid = fixture.componentInstance.grid;
    ...
    it('Should not break KB after columns are reordered - selection belongs to the moved column.', fakeAsync(() => {
        ...
        const cellEl = grid.getCellByColumn(0, 'ID');
    ...
    it('MCH - should not break selection and keyboard navigation when reordering columns.', fakeAsync(() => {
        const fixture = TestBed.createComponent(MultiColumnHeadersComponent);
        fixture.detectChanges();
        const grid = fixture.componentInstance.grid;
