...
@Component({
    template: GridTemplateStrings.declareGrid('', '', ColumnDefinitions.idNameJobHireDate, '', `@if (paging) {
...
@Component({
    template: GridTemplateStrings.declareGrid(``, '', ColumnDefinitions.idNameJobTitle, '', `@if (paging) {
