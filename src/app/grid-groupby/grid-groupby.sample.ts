...
export class GridGroupBySampleComponent implements OnInit {
    ...
    public ngOnInit(): void {
        this.columns = [
            ...
            { dataType: 'number', field: 'Salary', width: 200, pinned: true, groupable: true },
            { dataType: 'string', field: 'Another', width: 200, pinned: true, groupable: true },
            { dataType: 'string', field: 'YetAnother', width: 200, pinned: true, groupable: true },
        ...
        this.data = [
            ...
            { 'Salary': 1000, 'CompanyName': 'Tesla', 'Another': 'Sport Edition', 'YetAnother': 'Lease' },
            { 'Salary': 2000,'CompanyName': 'Audi', 'Another': 'Business Edition', 'YetAnother': 'Lease'  },
            { 'Salary': 2000,'CompanyName': 'Tesla', 'Another': 'Comfort Edition', 'YetAnother': 'Cash'  },
            { 'Salary': 3000,'CompanyName': 'BMW' , 'Another': 'Performance Edition', 'YetAnother': 'Cash' },
            { 'Salary': 3000,'CompanyName': 'Tesla' , 'Another': 'Performance Edition', 'YetAnother': 'Cash' },
            { 'Salary': 3000, 'CompanyName': 'BMW', 'Another': 'Comfort Edition', 'YetAnother': 'Credit'  },
            { 'Salary': 4000, 'CompanyName': 'Audi', 'Another': 'Comfort Edition', 'YetAnother': 'Lease'  },
            { 'Salary': 4000,'CompanyName': 'Audi', 'Another': 'Business Edition', 'YetAnother': 'Credit'  },
            { 'Salary': 4000,'CompanyName': 'BMW' , 'Another': 'Sport Edition', 'YetAnother': 'Credit' },
            { 'Salary': 4000,'CompanyName': 'Tesla', 'Another': 'Business Edition', 'YetAnother': 'Cash'  },
        ];
    }
