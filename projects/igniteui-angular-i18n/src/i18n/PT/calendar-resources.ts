...
export const CalendarResourceStringsPT = {
    ...
    igx_calendar_previous_year: 'Ano anterior',
    igx_calendar_next_year: 'Ano seguinte',
    igx_calendar_previous_years: '{0} anos anteriores',
    igx_calendar_next_years: 'Próximos {0} anos',
    igx_calendar_select_month: 'Selecionar mês',
    igx_calendar_select_date: 'Selecionar data',
    ...
    igx_calendar_range_label_start: 'Início',
    igx_calendar_range_label_end: 'Fim',
    igx_calendar_range_placeholder: 'Selecionar intervalo',
