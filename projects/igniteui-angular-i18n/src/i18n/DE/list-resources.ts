...
const ListResourceStringsDE_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsDE = ListResourceStringsDE_ as ExpandRequire<IListResourceStrings>;
