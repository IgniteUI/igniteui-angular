...
const CarouselResourceStringsPL_: ExpandRequire<ICarouselResourceStrings> = {
    igx_carousel_of: 'z',
 ...
 */
export const CarouselResourceStringsPL = CarouselResourceStringsPL_ as ExpandRequire<ICarouselResourceStrings>;
