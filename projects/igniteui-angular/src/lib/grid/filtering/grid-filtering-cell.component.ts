...
export class IgxGridFilteringCellComponent implements OnInit, AfterViewInit, DoCheck {
    ...
    ngOnInit(): void {
        this.filteringService.expressionsMap.set(this.column.field, new Array<ExpressionUI>());
