...
import { TimePickerResourceStringsPT as ATimePickerResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const TimePickerResourceStringsPT = prefixResource(IGX_PREFIX, ATimePickerResourceStrings);
