import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, HostBinding, Inject, Input, NgZone, SimpleChanges, TemplateRef, ViewChild } from '@angular/core';
