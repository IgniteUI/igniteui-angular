...
describe("Unit testing FilteringCondition", function () {
    it("tests string conditions", function () {
        var fc = filtering_condition_1.FilteringCondition.string;
        // contains
    ...
    it("tests number conditions", function () {
        var fn = filtering_condition_1.FilteringCondition.number;
    ...
    it("tests date conditions", function () {
        var fd = filtering_condition_1.FilteringCondition.date;
        var now = new Date();
        var cnow = new Date();
        var yesterday = (function (d) { return new Date(d.setDate(d.getDate() - 1)); })(new Date());
        var lastMonth = (function (d) { d.setDate(1); return new Date(d.setMonth(d.getMonth() - 1)); })(new Date());
        var nextMonth = (function (d) { d.setDate(1); return new Date(d.setMonth(d.getMonth() + 1)); })(new Date());
        var lastYear = (function (d) { return new Date(d.setFullYear(d.getFullYear() - 1)); })(new Date());
        var nextYear = (function (d) { return new Date(d.setFullYear(d.getFullYear() + 1)); })(new Date());
    ...
    it("tests boolean conditions", function () {
        var f = filtering_condition_1.FilteringCondition.boolean;
...
//# sourceMappingURL=filtering-condition.spec.js.map
