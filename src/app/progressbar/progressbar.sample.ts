...
import { IgxProcessBarTextTemplateDirective, IgxProgressBarGradientDirective } from '../../../projects/igniteui-angular/src/lib/progressbar/progressbar.common';
...
@Component({
    ...
    standalone: true,
    imports: [IgxLinearProgressBarComponent, IgxCircularProgressBarComponent, IgxProcessBarTextTemplateDirective, IgxProgressBarGradientDirective, IgxButtonDirective, IgxRippleDirective, IgxIconComponent]
})
