...
const PaginatorResourceStringsTR_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsTR = PaginatorResourceStringsTR_ as ExpandRequire<IPaginatorResourceStrings>;
