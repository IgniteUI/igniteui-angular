...
const ListResourceStringsSV_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsSV = ListResourceStringsSV_ as ExpandRequire<IListResourceStrings>;
