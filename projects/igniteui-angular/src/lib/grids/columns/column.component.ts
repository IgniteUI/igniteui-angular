 ...
 *
 * @igxParent IgxGridElementsComponent, IgxHierarchicalGridElementsComponent, IgxTreeGridComponent, IgxPivotGridComponent, IgxRowIslandElementsComponent, IgxColumnGroupComponent, IgxColumnLayoutComponent,
 */
@Component({
