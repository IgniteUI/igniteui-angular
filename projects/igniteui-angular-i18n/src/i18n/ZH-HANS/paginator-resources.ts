...
import { PaginatorResourceStringsZHHANS as APaginatorResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const PaginatorResourceStringsZHHANS = prefixResource(IGX_PREFIX, APaginatorResourceStrings);
