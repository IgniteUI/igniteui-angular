...
const PaginatorResourceStringsZHHANT_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsZHHANT = PaginatorResourceStringsZHHANT_ as ExpandRequire<IPaginatorResourceStrings>;
