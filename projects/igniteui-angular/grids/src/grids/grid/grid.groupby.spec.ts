...
import { MultiColumnHeadersWithGroupingComponent } from '../../../core/src/test-utils/grid-samples.spec';
import { GridSelectionFunctions, GridFunctions, GRID_SCROLL_CLASS } from '../../../core/src/test-utils/grid-functions.spec';
import { GridSelectionMode } from '../common/enums';
import { ControlsFunction } from '../../../core/src/test-utils/controls-functions.spec';
import { ymd } from '../../../core/src/test-utils/helper-utils.spec';
...
describe('IgxGrid - GroupBy #grid', () => {
    ...
    both grouping and un-grouping at the same time.`, fakeAsync(() => {
        const fix = TestBed.createComponent(DefaultGridComponent);
        const grid = fix.componentInstance.instance;
        grid.primaryKey = 'ID';
        fix.detectChanges();
