...
const ListResourceStringsPT_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsPT = ListResourceStringsPT_ as ExpandRequire<IListResourceStrings>;
