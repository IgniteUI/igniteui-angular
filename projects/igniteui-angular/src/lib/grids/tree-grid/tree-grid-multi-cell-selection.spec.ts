...
describe('IgxTreeGrid - Multi Cell selection #tGrid', () => {
    ...
    describe('Flat Data', () => {
        ...
        it('Should not change selection when expand collapse row with keyboard', (async () => {
            ...
            let startCell = treeGrid.gridAPI.get_cell_by_index(10, 'ID');
            const endCell = treeGrid.gridAPI.get_cell_by_index(11, 'ID');
        ...
        it('Should be able to select a range with holding Shift key', (async () => {
            ...
            const secondCell = treeGrid.gridAPI.get_cell_by_index(16, 'HireDate');
            ...
            const thirdCell = treeGrid.gridAPI.get_cell_by_index(4, 'ID');
        ...
        it('Should be able to select a range with keyboard', (async () => {
            ...
            for (let i = 4; i > 2; i--) {
                cell = treeGrid.gridAPI.get_cell_by_index(3, treeGrid.columns[i].field);
        ...
        it('Summaries: should select correct data when summaries are enabled', () => {
            ...
            let newCell = treeGrid.gridAPI.get_cell_by_index(10, 'Name');
            ...
            newCell = treeGrid.gridAPI.get_cell_by_index(10, 'Age');
            UIInteractions.simulatePointerOverElementEvent('pointerenter', newCell.nativeElement);
        ...
        it('Summaries: should select range with keyboard', (async () => {
            ...
            for (let i = 8; i < 16; i++) {
                let cellObj = treeGrid.gridAPI.get_cell_by_index(i, 'Name');
                if (!cellObj) {
        ...
        it('Summaries: should clear selected range when navigate from summary cell without pressed shift', (async () => {
            ...
            const cellElem = treeGrid.gridAPI.get_cell_by_index(8, 'Name');
            UIInteractions.simulateClickAndSelectEvent(cellElem);
            fix.detectChanges();

            GridSelectionFunctions.verifyCellSelected(cellElem);
