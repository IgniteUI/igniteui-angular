...
const CalendarResourceStringsPT_: ExpandRequire<ICalendarResourceStrings> = {
 ...
 */
export const CalendarResourceStringsPT = CalendarResourceStringsPT_ as ExpandRequire<ICalendarResourceStrings>;
