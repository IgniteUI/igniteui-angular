...
describe('Update to 11.1.0', () => {
    ...
    it('should update fontSet to family', async () => {
        appTree.create(`/testSrc/appPrefix/component/icon.component.html`, '<igx-icon fontSet="material">settings</igx-icon>');

        const tree = await runner
            .runSchematic('migration-19', {}, appTree);

        expect(tree.readContent('/testSrc/appPrefix/component/icon.component.html')).toEqual('<igx-icon family="material">settings</igx-icon>');
    });

    it('should update isActive to active', async () => {
        appTree.create(`/testSrc/appPrefix/component/icon.component.html`, '<igx-icon [isActive]="false">settings</igx-icon>');

        const tree = await runner
            .runSchematic('migration-19', {}, appTree);

        expect(tree.readContent('/testSrc/appPrefix/component/icon.component.html')).toEqual('<igx-icon [active]="false">settings</igx-icon>');
    });
...
`;
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/icon-test.component.ts')).toEqual(expectedContent);
    });
...
`;
    ...
    it('should replace on-prefixed outputs in chip and chips-area', async () => {
        appTree.create(`/testSrc/appPrefix/component/chips.component.html`, `<igx-chips-area #chipsAreaTo class="chipAreaTo"
    ...
    it('should replace IgxTabsComponent event name onTabItemSelected with tabItemSelected', async () => {
        appTree.create(`/testSrc/appPrefix/component/tabs.component.html`, `<igx-tabs (onTabItemSelected)="tabSelected()"></igx-tabs>`);

        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/tabs.component.html')).toEqual(`<igx-tabs (tabItemSelected)="tabSelected()"></igx-tabs>`);
    });

    it('should replace IgxTabsComponent event name onTabItemDeselected with tabItemDeselected', async () => {
        appTree.create(`/testSrc/appPrefix/component/tabs.component.html`, `<igx-tabs (onTabItemDeselected)="tabDeselected()"></igx-tabs>`);

        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/tabs.component.html')).toEqual(`<igx-tabs (tabItemDeselected)="tabDeselected()"></igx-tabs>`);
    });

    it('should replace IgxListComponent event name onLeftPan with leftPan', async () => {
        appTree.create(`/testSrc/appPrefix/component/list.component.html`, `<igx-list [allowLeftPanning]="true" (onLeftPan)="leftPanPerformed($event)">`);

        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/list.component.html')).toEqual(`<igx-list [allowLeftPanning]="true" (leftPan)="leftPanPerformed($event)">`);
    });

    it('should replace IgxListComponent event name onRightPan with rightPan', async () => {
        appTree.create(`/testSrc/appPrefix/component/list.component.html`, `<igx-list [allowRightPanning]="true" (onRightPan)="rightPanPerformed($event)">`);

        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/list.component.html')).toEqual(`<igx-list [allowRightPanning]="true" (rightPan)="rightPanPerformed($event)">`);
    });

    it('should replace IgxListComponent event name onPanStateChange with panStateChange', async () => {
        appTree.create(`/testSrc/appPrefix/component/list.component.html`, `<igx-list (onPanStateChange)="panStateChange($event)"></igx-list>`);

        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/list.component.html')).toEqual(`<igx-list (panStateChange)="panStateChange($event)"></igx-list>`);
    });

    it('should replace IgxListComponent event name OnItemClicked with itemClicked', async () => {
        appTree.create(`/testSrc/appPrefix/component/list.component.html`, `<igx-list (onItemClicked)="onItemClicked($event)"></igx-list>`);

        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/list.component.html')).toEqual(`<igx-list (itemClicked)="onItemClicked($event)"></igx-list>`);
    });

    it('should replace IgxNavbarComponent event name onAction with action', async () => {
        appTree.create(`/testSrc/appPrefix/component/navbar.component.html`, `<igx-navbar (onAction)="actionExc($event)" title="Sample App" actionButtonIcon="menu"></igx-navbar>`);

        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/navbar.component.html')).toEqual(`<igx-navbar (action)="actionExc($event)" title="Sample App" actionButtonIcon="menu"></igx-navbar>`);
    });
...
`;
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/excel-export.component.ts')).toEqual(expectedContent);
    });
...
`;
        expect(tree.readContent('/testSrc/appPrefix/component/csv-export.component.ts')).toEqual(expectedContent);
    });

    it('should replace onSelect and onUnselect with selected and deselected in igx-buttongroup', async () => {
        appTree.create(`/testSrc/appPrefix/component/buttongroup.component.html`, `<igx-buttongroup
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/buttongroup.component.html')).toEqual(`<igx-buttongroup
    ...
    it('should replace onAction with clicked in igx-snackbar', async () => {
        appTree.create(`/testSrc/appPrefix/component/snackbar.component.html`, `<igx-snackbar (onAction)="someHandler($event)"></igx-snackbar>`);

        const tree = await runner.runSchematic(migrationName, { shouldInvokeLS: false }, appTree);

        expect(tree.readContent('/testSrc/appPrefix/component/snackbar.component.html')).toEqual(`<igx-snackbar (clicked)="someHandler($event)"></igx-snackbar>`);
    });

    it('should replace onShowing, onShown, onHiding, onHidden with showing, shown, hiding, hidden in igx-toast', async () => {
        appTree.create(`/testSrc/appPrefix/component/toast.component.html`, `<igx-toast
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/toast.component.html')).toEqual(`<igx-toast
    ...
    it('should replace IgxTooltipTargetDirective event names onTooltipShow and onTooltipHide with tooltipShow and tooltipHide', async () => {
        appTree.create(`/testSrc/appPrefix/component/tooltip.component.html`, `<button [igxTooltipTarget]="tooltipRef" (onTooltipShow)="showing($event)" (onTooltipHide)="hiding($event)">
        Hover me
    </button>
    <div igxTooltip #tooltipRef="tooltip">
        ...
        const tree = await runner
            .runSchematic(migrationName, { shouldInvokeLS: false }, appTree);
        expect(tree.readContent('/testSrc/appPrefix/component/tooltip.component.html')).toEqual(`<button [igxTooltipTarget]="tooltipRef" (tooltipShow)="showing($event)" (tooltipHide)="hiding($event)">
        Hover me
    </button>
    <div igxTooltip #tooltipRef="tooltip">
        Hello, I am a tooltip!
    ...
    it('should replace outputs with selected in igx-calendar', async () => {
        appTree.create(`/testSrc/appPrefix/component/calendar.component.html`, `<igx-calendar
...
></igx-calendar>`);
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/calendar.component.html')).toEqual(`<igx-calendar
    (selected)="someHandler($event)"
...
></igx-calendar>`);
    ...
    it('should replace onSelection and onYearSelection with selected in igx-years-view', async () => {
        appTree.create(`/testSrc/appPrefix/component/yearsview.component.html`, `<igx-years-view
...
></igx-years-view>`);
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/yearsview.component.html')).toEqual(`<igx-years-view
...
></igx-years-view>`);
    ...
    it('should replace onDateSelection and onViewChanging with selected in igx-days-view', async () => {
        appTree.create(`/testSrc/appPrefix/component/daysview.component.html`, `<igx-days-view
    (onDateSelection)="someHandler($event)"
    (onViewChanging)="someHandler($event)"
></igx-days-view>`);
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/daysview.component.html')).toEqual(`<igx-days-view
    (dateSelection)="someHandler($event)"
    (viewChanging)="someHandler($event)"
></igx-days-view>`);
    });
    ...
    it('should replace onSelection and onMonthSelection with selected in igx-months-view', async () => {
        appTree.create(`/testSrc/appPrefix/component/monthsview.component.html`, `<igx-months-view
    (onSelection)="someHandler($event)"
    (onMonthSelection)="someHandler($event)"
></igx-months-view>`);
        ...
        expect(tree.readContent('/testSrc/appPrefix/component/monthsview.component.html')).toEqual(`<igx-months-view
    (selected)="someHandler($event)"
    (monthSelection)="someHandler($event)"
></igx-months-view>`);
    });
    ...
    it('should replace onSelection and onMonthSelection with selected in igx-month-picker', async () => {
        appTree.create(`/testSrc/appPrefix/component/monthpicker.component.html`, `<igx-month-picker
    (onSelection)="someHandler($event)"
></igx-month-picker>`);

        const tree = await runner.runSchematic(migrationName, { shouldInvokeLS: false }, appTree);

        expect(tree.readContent('/testSrc/appPrefix/component/monthpicker.component.html')).toEqual(`<igx-month-picker
    (selected)="someHandler($event)"
></igx-month-picker>`);
    });
