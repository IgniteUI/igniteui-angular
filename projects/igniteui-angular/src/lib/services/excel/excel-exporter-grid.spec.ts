...
describe('Excel Exporter', () => {
    ...
    describe('', () => {
        ...
        it('should honor columns visibility changes.', async () => {
            ...
            grid.columnsCollection[0].hidden = false;
            fix.detectChanges();
            ...
            grid.columnsCollection[0].hidden = undefined;
            fix.detectChanges();
        ...
        it('should honor pinned state changes.', async () => {
            ...
            grid.columnsCollection[1].pinned = false;
            fix.detectChanges();
            wrapper = await getExportedData(grid, options);
        ...
        it('should export all columns with the width specified in options.', async () => {
            ...
            const grid = fix.componentInstance.grid;
            grid.columnsCollection[1].hidden = true;
        ...
        it('shouldn\'t affect grid sort expressions', async () => {
            ...
            const grid = fix.componentInstance.grid;
            grid.columnsCollection[1].header = 'My header';
            grid.columnsCollection[1].sortable = true;
        ...
        it('should skip the column formatter when \'columnExporting\' skipFormatter is true', async () => {
            ...
            grid.columnsCollection[0].formatter = ((val: number) => {
    ...
    describe('', () => {
        ...
        it('should skip the formatter when columnExporting skipFormatter is true', async () => {
            treeGrid.columnsCollection[4].formatter = ((val: number) => {
    ...
    describe('', () => {
        ...
        it('should export grid with multi column headers and moved column', async () => {
            grid.columnsCollection[0].move(2);
            fix.detectChanges();
        ...
        it('should export grid with pinned column group', async () => {
            grid.columnsCollection[1].pinned = true;
            fix.detectChanges();
        ...
        it('should export grid with collapsed and expanded multi column headers', async () => {
            GridFunctions.clickGroupExpandIndicator(fix, grid.columnsCollection[1]);
            GridFunctions.clickGroupExpandIndicator(fix, grid.columnsCollection[7]);
            fix.detectChanges();
