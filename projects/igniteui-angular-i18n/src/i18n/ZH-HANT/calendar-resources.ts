...
const CalendarResourceStringsZHHANT_: ExpandRequire<ICalendarResourceStrings> = {
 ...
 */
export const CalendarResourceStringsZHHANT = CalendarResourceStringsZHHANT_ as ExpandRequire<ICalendarResourceStrings>;
