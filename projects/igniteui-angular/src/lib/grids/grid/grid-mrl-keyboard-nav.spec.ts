    ...
    describe('Navigation without scrolling', () => {
        describe('General', () => {
            it('should navigate through a single layout with right and left arrow keys', () => {
                ...
                firstCell.componentInstance.onClick(UIInteractions.getClickEvent('click'));
                fix.detectChanges();
            ...
            it('should navigate between column layouts with right arrow key', () => {
                ...
                secondCell.componentInstance.onClick(UIInteractions.getClickEvent('click'));
                fix.detectChanges();
            ...
            it('should navigate between column layouts with left key', () => {
                ...
                thirdCell .componentInstance.onClick(UIInteractions.getClickEvent('click'));
                fix.detectChanges();
            ...
            it(`should navigate to the first cell from the layout by pressing Ctrl + Arrow Left and Right key
                ...
                lastCell.componentInstance.onClick(UIInteractions.getClickEvent('click'));
                fix.detectChanges();
    ...
    describe('Navigation with scrolling', () => {
        describe('General', () => {
            ...
            it('Shift + tab navigation should scroll to the appropriate cell', async() => {
                ...
                secondRowCells[0].componentInstance.onClick(UIInteractions.getClickEvent('click'));
                fix.detectChanges();
