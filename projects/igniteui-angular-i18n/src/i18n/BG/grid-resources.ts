...
export const GridResourceStringsBG = {
    ...
    igx_grid_filter_in: 'В/във',
    igx_grid_filter_notIn: 'Не е в/във',
    ...
    igx_grid_advanced_filter_from_label: 'От',
    ...
    igx_grid_advanced_filter_switch_group: 'Премини към {0}',
    igx_grid_advanced_filter_add_condition: 'Добави условие',
    igx_grid_advanced_filter_add_group: 'Добави група',
    igx_grid_advanced_filter_add_condition_root: 'Условие',
    igx_grid_advanced_filter_add_group_root: 'Група',
    ...
    igx_grid_advanced_filter_query_value_placeholder: 'Резултати от подзаявки',
    igx_grid_advanced_filter_select_entity: 'Избери обект',
    igx_grid_advanced_filter_select_return_field_single: 'Избери поле(та) за връщане',
    igx_grid_advanced_filter_dialog_title: 'Потвърждение',
    igx_grid_advanced_filter_dialog_message: 'С промяната на обекта ще загубите текущите си настройки. Сигурни ли сте, че искате да продължите?',
    igx_grid_advanced_filter_dialog_checkbox_text: 'Не показвай този диалогов прозорец отново',
    igx_grid_advanced_filter_drop_ghost_text: 'Постави тук за вмъкване',
