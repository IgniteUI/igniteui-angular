...
import { GridFunctions, GRID_MRL_BLOCK_CLASS } from '../../test-utils/grid-functions.spec';
...
describe('IgxGrid - multi-row-layout Integration #grid - ', () => {
    ...
    describe('Resizing', () => {
        ...
        it('should correctly resize column that does not have width set, but is intersected by a column with width set', async () => {
            ...
            let groupRowBlocks = fixture.debugElement.query(By.css('.igx-grid__tbody')).queryAll(By.css(`.${GRID_MRL_BLOCK_CLASS}`));
            expect(groupRowBlocks[0].nativeElement.style.gridTemplateColumns).toEqual('200px 200px 700px 100px 100px 200px');
            ...
            groupRowBlocks = fixture.debugElement.query(By.css('.igx-grid__tbody')).queryAll(By.css(`.${GRID_MRL_BLOCK_CLASS}`));
