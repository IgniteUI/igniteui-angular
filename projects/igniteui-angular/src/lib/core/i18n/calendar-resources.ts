export interface ICalendarResourceStrings {
	...
	igx_selected_month_is: string;
	igx_calendar_component_navigation: string;
}
...
export const CalendarResourceStringsEN: ICalendarResourceStrings = {
	...
	igx_selected_month_is: 'Selected month',
	igx_calendar_component_navigation: 'Calendar component navigation'
};
