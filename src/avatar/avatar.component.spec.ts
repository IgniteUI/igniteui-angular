...
import { IgxAvatarModule, IgxAvatar } from './avatar.component';
...
describe('Avatar', function () {
    ...
    it('Initializes binded avatar with initials', () => {
        let fixture = TestBed.createComponent(AvatarWithAttribs);
        fixture.detectChanges();
        let avatar = fixture.componentInstance.avatar;
    ...
    it('Initializes image avatar with src element', () => {
        let fixture = TestBed.createComponent(InitImageAvatar);
        fixture.detectChanges();
        let avatar = fixture.componentInstance.avatar;
    ...
    it("Should set ARIA attributes.", () => {
        let fixture = TestBed.createComponent(InitAvatarWithAria);
        fixture.detectChanges();
        let avatar = fixture.componentInstance.avatar;
