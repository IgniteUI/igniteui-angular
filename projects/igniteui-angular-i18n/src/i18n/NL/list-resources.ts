...
const ListResourceStringsNL_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsNL = ListResourceStringsNL_ as ExpandRequire<IListResourceStrings>;
