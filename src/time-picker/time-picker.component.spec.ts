...
describe("IgxTimePicker", () => {
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [
                ...
                IgxTimePickerWithPassed_PM_TimeComponent
            ],
    ...
    it("Dialog header value", () => {
        const fixture = TestBed.createComponent(IgxTimePickerWithPassed_PM_TimeComponent);
        fixture.detectChanges();
        
        //get time-picker value
        const testElementTIme = fixture.componentInstance.dateValue;
        const formatedTestElementTime = `${testElementTIme.getHours()}:${testElementTIme.getMinutes()} ${testElementTIme.getHours() >= 12 ? "PM" : "AM"}`;
        ...
        const formatedTimeFromPopupHeader = `${getTimeFromPopupHeader[1].innerText.replace(/\n/g,"")} ${getTimeFromPopupHeader[0].innerText}`
...
export class IgxTimePickerWithPassed_PM_TimeComponent {
