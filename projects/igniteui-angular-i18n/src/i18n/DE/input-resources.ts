...
import { InputResourceStringsDE as AInputResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const InputResourceStringsDE = prefixResource(IGX_PREFIX, AInputResourceStrings);
