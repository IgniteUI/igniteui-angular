...
import { GridType, IGX_GRID_BASE, IGX_GRID_SERVICE_BASE, IgxColumnTemplateContext, PivotGridType, RowType } from '../common/grid.interface';
...
import { FilterMode, GridPagingMode, GridSummaryPosition } from '../common/enums';
