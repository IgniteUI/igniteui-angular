...
export class DataUtil {
    ...
    public static group<T>(data: T[], state: IGroupingState, rowHeight: number, groupsRecords: any[] = []): IGroupByResult {
        const grouping = new IgxGrouping();
        groupsRecords.splice(0, groupsRecords.length);
        return grouping.groupBy(data, state.expressions, rowHeight, groupsRecords);
    }
