...
describe('IgxGridState - input properties #grid', () => {
    ...
    it('getState should return corect JSON string', () => {
        ...
        const initialGridState = '{"columns":[{"pinned":true,"sortable":true,"filterable":true,"editable":true,"sortingIgnoreCase":true,"filteringIgnoreCase":true,"headerClasses":"","headerGroupClasses":"","movable":true,"dataType":"string","field":"FirstName","width":"197px","header":"First Name","resizable":false,"searchable":true},{"pinned":true,"sortable":true,"filterable":true,"editable":true,"sortingIgnoreCase":true,"filteringIgnoreCase":true,"headerClasses":"","headerGroupClasses":"","movable":true,"dataType":"string","field":"LastName","width":"197px","header":"Last Name","resizable":false,"searchable":true},{"sortable":true,"filterable":true,"editable":true,"sortingIgnoreCase":true,"filteringIgnoreCase":true,"headerClasses":"","headerGroupClasses":"","groupable":true,"movable":true,"dataType":"string","field":"Country","width":"197px","header":"Country","resizable":false,"searchable":true},{"sortable":true,"filterable":true,"editable":true,"sortingIgnoreCase":true,"filteringIgnoreCase":true,"headerClasses":"","headerGroupClasses":"","movable":true,"dataType":"number","hasSummary":true,"field":"Age","width":"197px","header":"Age","resizable":false,"searchable":true},{"sortable":true,"filterable":true,"editable":true,"sortingIgnoreCase":true,"filteringIgnoreCase":true,"headerClasses":"","headerGroupClasses":"","movable":true,"dataType":"date","field":"RegistererDate","width":"197px","header":"Registerer Date","resizable":false,"searchable":true},{"sortable":true,"filterable":true,"editable":true,"sortingIgnoreCase":true,"filteringIgnoreCase":true,"headerClasses":"","headerGroupClasses":"","groupable":true,"movable":true,"dataType":"boolean","field":"IsActive","width":"197px","header":"Is Active","resizable":false,"searchable":true}],"filtering":{"filteringOperands":[],"operator":0},"sorting":[],"paging":{"index":0,"recordsPerPage":15,"metadata":{"countPages":3,"countRecords":38,"error":0}},"cellSelection":[],"rowSelection":[],"columnSelection":[],"rowPinning":[],"expansion":[],"groupBy":{"expressions":[],"expansion":[],"defaultExpanded":true}}';
        const fix = TestBed.createComponent(IgxGridStateComponent);
        fix.detectChanges();
