...
describe('IgxTreeGrid - search API #tGrid', () => {
    ...
    describe('Primary/Foreign key', () => {
        ...
        it('Should update search highlights when sorting', () => {
            ...
            // Apply asc sorting
            treeGrid.allColumns.filter(c => c.field === 'JobTitle')[0].sortable = true;
            fix.detectChanges();
        ...
        it('Should update search highlights when a column is pinned/unpinned', () => {
            ...
            // Pin column
            const column = treeGrid.allColumns.filter(c => c.field === 'Name')[0];
            column.pinned = true;
            fix.detectChanges();
    ...
    describe('Scrollable TreeGrid', () => {
        beforeEach(async() => {
            ...
            treeGrid.allColumns[3].hasSummary = false;
            fix.detectChanges();
        });
