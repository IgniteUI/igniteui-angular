...
const ListResourceStringsDA_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsDA = ListResourceStringsDA_ as ExpandRequire<IListResourceStrings>;
