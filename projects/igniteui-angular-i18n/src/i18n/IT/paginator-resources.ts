...
const PaginatorResourceStringsIT_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsIT = PaginatorResourceStringsIT_ as ExpandRequire<IPaginatorResourceStrings>;
