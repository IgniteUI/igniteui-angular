...
import { DateRangePickerResourceStringsDA as ADateRangePickerResourceStrings } from 'igniteui-i18n-resources';
 ...
 */
export const DateRangePickerResourceStringsDA = prefixResource(IGX_PREFIX, ADateRangePickerResourceStrings);
