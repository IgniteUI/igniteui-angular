...
> **Note:** The `outlet` property in overlay settings is deprecated. Use `keepInPlace: true` in your overlay settings to keep the overlay in its original DOM position instead.
