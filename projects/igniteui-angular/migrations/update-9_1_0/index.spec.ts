...
describe('Update 9.1.0', () => {
    ...
    it('should update igx-group supressInputAutofocus to suppressInputAutofocus', async () => {
        appTree.create(`/testSrc/appPrefix/component/input.component.html`, '<igx-input-group [supressInputAutofocus]="true"><input igxInput></igx-input-group>');
    ...
    it('should move igx-toast message property between element tags', async () => {
        appTree.create(`/testSrc/appPrefix/component/input.component.html`, '<igx-toast message="test message"></igx-toast>');
    ...
    it('should update rowSelectable to rowSelection', async () => {
        appTree.create(`/testSrc/appPrefix/component/input.component.html`, `<igx-grid [rowSelectable]="true"></igx-grid>`);
    ...
    it('should update rowSelectable to rowSelection when false', async () => {
        appTree.create(`/testSrc/appPrefix/component/input.component.html`, `<h5 style="margin-top: 30px;">[rowSelectable]="true"</h5>
