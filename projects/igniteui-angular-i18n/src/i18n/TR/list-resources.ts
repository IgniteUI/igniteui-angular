...
const ListResourceStringsTR_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsTR = ListResourceStringsTR_ as ExpandRequire<IListResourceStrings>;
